document.addEventListener('DOMContentLoaded', function() {
    ...
    [["", ["", "", "Spielkarte", ""]], ["Dinge, die man immer im Haus verliert/nicht findet", ["Brille", "Fernbedienung", "Schlüssel", "Socken"]], ["Können platzen", ["Blase", "Luftballon", "Reifen", "Traum"]], ["_Wahl", ["Brief", "Kreis", "Protest", "Wieder"]]], 
    [["Werden in vier aufgeteilt", ["Basketballspiel", "Himmelsrichtung", "Rechenart", "Spielkarte"]], ["Beginnen mit Zeitabschnitten", ["Jahreszeit", "Stundenlohn", "Tagung", "Wochentag"]], ["Können gedreht werden", ["Flasche", "Kopf", "Schlüssel", "Schraube"]], ["Werden 'abgegeben'", ["Geruch", "Löffel", "Tipp", "Verpflichtung"]]], 
